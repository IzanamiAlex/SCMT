...
public class ViewModifyProductPanel extends SwitchJPanel {
    ...
    private void initComponents() {
        ...
        minimunStockLabel.setText("Cantidad minima");
    ...
    private void modifyProvider(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyProvider
        ...
        double currentStock = Double.valueOf(currentStockTextField.getText());
        double minimunStock = Double.valueOf(minimunStockTextField.getText());
        adminProduct.modifyProduct(barcode, description, prieUnit, saleUnit, departament, currentStock, minimunStock);
